package parser;/* LangParserTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. LangParserTokenManager.java */
import java.io.*;
import parser.First;
...
/** Token Manager. */
@SuppressWarnings("unused")public class LangParserTokenManager implements LangParserConstants {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 143:
                  ...
                  break;
               case 144:
                  if ((0x500000000000L & l) != 0L && kind > 71)
                     kind = 71;
                  break;
               case 145:
                  if ((0x3ff000000000000L & l) != 0L)
...
static final int[] jjnextStates = {
   95, 96, 98, 100, 104, 107, 112, 123, 133, 139, 144, 145, 149, 153, 157, 161, 
   3, 8, 170, 171, 172, 173, 174, 164, 165, 166, 167, 168, 17, 19, 18, 14, 
   20, 21, 23, 24, 35, 36, 37, 76, 77, 78, 95, 96, 98, 146, 144, 147, 
   148, 146, 144, 147, 150, 133, 151, 152, 150, 133, 151, 154, 107, 155, 156, 154, 
   107, 155, 158, 100, 159, 160, 158, 100, 159, 89, 90, 92, 81, 82, 84, 86, 
   13, 14, 26, 27, 28, 31, 32, 34, 40, 41, 42, 43, 47, 48, 53, 54, 
   55, 60, 61, 62, 66, 67, 68, 73, 74, 75, 49, 52, 39, 15, 16, 13, 
   14, 15, 16, 14, 15, 16, 26, 27, 28, 31, 32, 34, 39, 36, 37, 32, 
   33, 34, 39, 40, 41, 42, 43, 41, 42, 43, 47, 48, 49, 52, 50, 51, 
   48, 50, 51, 48, 49, 52, 53, 54, 55, 60, 61, 62, 66, 67, 68, 73, 
   74, 75, 77, 78, 164, 165, 166, 167, 170, 171, 172, 173, 
};
...
null, null, "\47", "\42", null, null, null, null, };
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public LangParserTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public LangParserTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
