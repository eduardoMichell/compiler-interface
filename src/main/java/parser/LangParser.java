...
output.add(new ErrorStruct("Invalid enum/variable declaration", e));
  ...
  final public void declarationOne(RecoverySet r) throws ParseException {
    trace_call("declarationOne");
    try {
      try {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case TYPE:{
...
output.add(new ErrorStruct("Invalid enum/variable declaration", e));
      ...
      trace_return("declarationOne");
    }
  }

  final public void declarationTwo(RecoverySet r) throws ParseException {
...
output.add(new ErrorStruct("Invalid enum declaration", e));
  ...
  final public void enumDeclarationOne(RecoverySet r) throws ParseException {
...
output.add(new ErrorStruct("Invalid enum declaration", e));
      ...
      trace_return("enumDeclarationOne");
    }
  }
  ...
  final public void innerEnumDeclarationOne() throws ParseException {
    ...
    try {
      ...
      trace_return("innerEnumDeclarationOne");
    }
  }
